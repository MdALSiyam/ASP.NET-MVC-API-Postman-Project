using MasterDetailCRUDBearerTokenWEbAPI.DTOs;
...
namespace MasterDetailCRUDBearerTokenWEbAPI.Controllers
{
    ...
    public class OrderController : ApiController
    {
        ...
        public IHttpActionResult GetOrderById(int id)
        {
            ...
            var orderItems = from o in db.OrderedItems
                             join p in db.Products on o.ProductId
                             equals p.ProductId
                             where o.OrderId == id
                             select new
                             { o.OrderId, o.OrderedItemId, o.ProductId, p.ProductName, o.Price, o.Quantity };
            return Ok(new { orderItems });
        }
